...
Launch the [`make.R`](https://github.com/ggrittz/Inventorying/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/ggrittz/Inventorying/blob/main/CONTRIBUTING.md).
