# Contributing to Inventorying

First off, thanks for taking the time to contribute to `Inventorying`!
...
[Contributor Code of Conduct](https://github.com/ggrittz/Inventorying/blob/master/CODE_OF_CONDUCT.md).
...
`Inventorying` uses the `lower_snake_case`.
...
[Issues](https://github.com/ggrittz/Inventorying/issues) that might help 
...
- Open a new [Issue](https://github.com/ggrittz/Inventorying/issues/new).
- Use the template [other_issue.md](https://github.com/ggrittz/Inventorying/blob/master/.github/ISSUE_TEMPLATE/other_issue.md).
...
- Make sure that you are using the latest version of `Inventorying`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/ggrittz/Inventorying/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/ggrittz/Inventorying/issues) to 
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/ggrittz/Inventorying/issues/new).
- Use the template [bug_report.md](https://github.com/ggrittz/Inventorying/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `Inventorying`.
- Read the [documentation](https://github.com/ggrittz/Inventorying/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/ggrittz/Inventorying/issues) to 
...
[GitHub Issues](https://github.com/ggrittz/Inventorying/issues).

- Open a new [Issue](https://github.com/ggrittz/Inventorying/issues/new).
- Use the template [feature_request.md](https://github.com/ggrittz/Inventorying/blob/master/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the suggestion.
- Provide a step-by-step description of the suggested enhancement in as 
many details as possible.
- Explain why this enhancement would be useful to most `Inventorying` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/ggrittz/Inventorying/compare).
